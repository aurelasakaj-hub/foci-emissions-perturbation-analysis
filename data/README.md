...
│   │   ├── Europe NOx emissions.png
│   │   ├── Europe SO₂ emissions.png
│   │   ├── Future CH₄ projections with perturbation.png
│   │   ├── Global CH₄ emissions (CEDS vs EDGAR).png
│   │   ├── Global CO₂ emissions (CEDS vs EDGAR).png
│   │   ├── Global NMVOC emissions.png
│   │   ├── Global NOx emissions.png
│   │   ├── Global SO₂ emissions (CEDS vs EDGAR).png
│   │   ├── Gridded difference map.png
│   │   └── Top 10 countries CH₄ differences.png
